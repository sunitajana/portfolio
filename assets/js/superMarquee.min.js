!function(e, t) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : (e = e || self).SuperMarquee = t()
}(this, function() {
    "use strict";
...
`;
    ...
    function Configuration(e={}) {
        ...
        this.easingValue = .025,
        this._currentSpeed = 0,
        this.setSpeed = function(e) {
            this.type === Configuration.TYPE_HORIZONTAL ? -1 < Object.keys(Configuration.SPEED_HORIZONTAL).indexOf(e) ? this.speed = +Configuration.SPEED_HORIZONTAL[e] : this.speed = 0 < +e ? +e : +Configuration.SPEED_HORIZONTAL[Configuration.DEFAULT.speed] : -1 < Object.keys(Configuration.SPEED_VERTICAL).indexOf(e) ? this.speed = +Configuration.SPEED_VERTICAL[e] : this.speed = 0 < +e ? +e : +Configuration.SPEED_VERTICAL[Configuration.DEFAULT.speed]
        }
        ,
        ...
        this.getSpeedWithEasing = function() {
            return this.easingValue < 1 && (this._currentSpeed = (1 - this.easingValue) * this._currentSpeed + this.easingValue * this.speed),
            this._currentSpeed
        }
        .bind(this),
        this.getSpeed = this.getSpeedNoEasing,
        this.setContent = function(e) {
            e && 0 < e.length ? this.content = e : this.content = "SuperMarquee by SuperPlug.in !!!",
            this.content = this.content.replaceAll("> ", ">&nbsp;"),
            this.content = this.content.replaceAll(" <", "&nbsp;<"),
            Configuration.MODE_PINGPONG === this.mode && Configuration.TYPE_HORIZONTAL === this.type && (this.content = this.spacer + this.content),
        ...
        this.setPerspective = function(e=null) {
            ...
            for (let e = 0; e < t.length; e++)
                i.hasOwnProperty(t[e]) ? this.perspective[t[e]] = i[t[e]] : this.perspective[t[e]] = Configuration.PERSPECTIVE_DEFAULT[t[e]]
        }
        ,
        this.setPosition = function(e) {
            -1 < Configuration.POSITIONS.indexOf(e) ? this.position = e : this.position = Configuration.DEFAULT.position
        }
        ,
        ...
        -1 < Configuration.SYSTEMS.indexOf(t) ? this.system = t : this.system = Configuration.DEFAULT.system;
        t = e.hasOwnProperty("license") ? e.license : null;
        this.license = null,
        t && 4 <= t.length && (this.license = e.license);
        t = e.hasOwnProperty("type") ? e.type : null;
        -1 < Configuration.TYPES.indexOf(t) ? this.type = t : this.type = Configuration.DEFAULT.type,
        this.spacer = e.hasOwnProperty("spacer") ? e.spacer : null,
        this.type === Configuration.TYPE_HORIZONTAL ? this.spacer ? this.spacer = Util.forceNbspInHtml(this.spacer) : this.spacer = "&nbsp;" : this.spacer || (this.spacer = "<br />");
        t = e.hasOwnProperty("direction") ? e.direction : null;
        -1 < Configuration.DIRECTIONS.indexOf(t) ? this.direction = t : this.direction = Configuration.DEFAULT.direction;
        t = e.hasOwnProperty("mode") ? e.mode : null;
        -1 < Configuration.MODES.indexOf(t) ? this.mode = t : this.mode = Configuration.MODE_CONTINOUS,
        this.pingPongDelay = e.hasOwnProperty("pingpongdelay") ? +e.pingpongdelay : Configuration.PINGPONG_DELAY_DEFAULT;
        t = e.hasOwnProperty("position") ? e.position : null;
        this.setPosition(t),
        this.perspective = {},
        this.setPerspective(e.hasOwnProperty("perspective") ? e.perspective : null);
        ...
        !t || "true" !== t && "1" !== t && !0 !== t ? (this.easing = !1,
        this.getSpeed = this.getSpeedNoEasing) : (this.easing = !0,
        this.getSpeed = this.getSpeedWithEasing),
        this.rssFeedUrl = e.hasOwnProperty("rssFeedUrl") ? e.rssFeedUrl : null,
        this.rssFeedTemplate = e.hasOwnProperty("rssFeedTemplate") ? Util.forceNbspInHtml(e.rssFeedTemplate) : this.rssFeedTemplate
    }
    function Event(e) {
        const t = e;
    ...
    const TickLogic = {
        ...
        fnHorizontalLtrPingPong: function(e) {
            1 === this._pingPongCurrentDirection ? (this._currentXPos += e * this.config.getSpeed(),
            this._currentXPos + this.dimensions.visibleWidth > this.dimensions.totalScrollItemWidth && (this._pingPongCurrentDirection = 0,
            this._pingPongNextDirection = -1)) : -1 === this._pingPongCurrentDirection ? (this._currentXPos -= e * this.config.getSpeed(),
            this._currentXPos <= 0 && (this._pingPongCurrentDirection = 0,
            this._pingPongNextDirection = 1)) : (this._pingPongPauseDelay -= e,
            this._pingPongPauseDelay < 0 && (this._pingPongCurrentDirection = this._pingPongNextDirection,
        ...
        fnHorizontalRtlPingPong: function(e) {
            1 === this._pingPongCurrentDirection ? (this._currentXPos -= e * this.config.getSpeed(),
            this._currentXPos < 0 && (this._currentXPos = 0,
            this._pingPongCurrentDirection = 0,
            TickLogic._pingPongNextDirection = -1)) : -1 === this._pingPongCurrentDirection ? (this._currentXPos += e * this.config.getSpeed(),
            this._currentXPos > this.dimensions.totalScrollItemWidth - this.dimensions.visibleWidth && (this._currentXPos = this.dimensions.totalScrollItemWidth - this.dimensions.visibleWidth,
            this._pingPongCurrentDirection = 0,
            this._pingPongNextDirection = 1)) : (this._pingPongPauseDelay -= e,
            this._pingPongPauseDelay < 0 && (this._pingPongCurrentDirection = this._pingPongNextDirection,
            this._pingPongPauseDelay = this.config.pingPongDelay)),
        ...
        fnHorizontalTtbPingPong: function(e) {
            1 === this._pingPongCurrentDirection ? (this._currentYPos -= e * this.config.getSpeed(),
            this._currentYPos < -(this.dimensions.totalScrollItemHeight - this.dimensions.visibleHeight) && (this._currentYPos = -(this.dimensions.totalScrollItemHeight - this.dimensions.visibleHeight),
            this._pingPongCurrentDirection = 0,
            this._pingPongNextDirection = -1)) : -1 === this._pingPongCurrentDirection ? (this._currentYPos += e * this.config.getSpeed(),
            0 < this._currentYPos && (this._currentYPos = 0,
            this._pingPongCurrentDirection = 0,
            this._pingPongNextDirection = 1)) : (this._pingPongPauseDelay -= e,
            this._pingPongPauseDelay < 0 && (this._pingPongCurrentDirection = this._pingPongNextDirection,
            this._pingPongPauseDelay = this.config.pingPongDelay)),
        ...
        fnHorizontalLtr: function(e) {
            ...
            this._currentXPos > this.dimensions.totalScrollItemWidth && (this._currentXPos = this.dimensions.totalScrollItemWidth - this._currentXPos),
            this.elems.innerContainer.style.transform = "translate3d(-" + this._currentXPos + "px,0,0)"
        },
        ...
        fnVerticalBtt: function(e) {
            ...
            this._currentYPos > this.dimensions.totalScrollItemHeight && (this._currentYPos = this.dimensions.totalScrollItemHeight - this._currentYPos),
            this.elems.innerContainer.style.transform = "translate3d(0, -" + this._currentYPos + "px,0)"
        },
        ...
        getFeedItemData: function(e) {
            ...
            if (i && 0 < i.length)
                for (let e = 0; e < i.length; e++)
                    console.log(i[e]),
                    n.push({
                        title: 0 < i[e].getElementsByTagName("title").length ? i[e].getElementsByTagName("title")[0].innerHTML : null,
                        link: 0 < i[e].getElementsByTagName("link").length ? i[e].getElementsByTagName("link")[0].innerHTML : null,
                        pubDate: 0 < i[e].getElementsByTagName("pubDate").length ? new Date(i[e].getElementsByTagName("pubDate")[0].innerHTML) : null,
                        description: 0 < i[e].getElementsByTagName("description").length && i[e].getElementsByTagName("description")[0].hasOwnProperty("firstChild") ? i[e].getElementsByTagName("description")[0].firstChild.wholeText.trim() : null,
                        content: 0 < i[e].getElementsByTagName("content").length ? i[e].getElementsByTagName("content")[0].innerHTML : null
                    });
            return n
        },
        getScrollContentOfFeed: function(e, t="&nbsp;") {
            ...
            if (n && 0 < n.length)
                for (let e = 0; e < n.length; e++)
                    s += '<a href="' + n[e].getElementsByTagName("link")[0].innerHTML + '" target="_blank">',
    ...
    function Core(root, config) {
        ...
        const listenerWindowResize = () => {
            if (this.elems.rootElement.offsetWidth === this._previousDimensions.width && this.elems.rootElement.offsetHeight === this._previousDimensions.height)
                return !1;
          ...
          , observer = new IntersectionObserver( (e, t) => {
            e = e.length ? e[0] : null;
            e && (!0 === e.isIntersecting ? this.onIntoView() : this.onOutOfView())
        }
        ,{
        ...
        function setup() {
            ...
            case Configuration.SYSTEM_WEBCOMPONENT:
                ...
                self.config.type === Configuration.TYPE_VERTICAL ? self.elems.shadowRoot.appendChild(templateVertical.content.cloneNode(!0)) : self.elems.shadowRoot.appendChild(templateHorizontal.content.cloneNode(!0)),
        ...
        this.init = function() {
            ...
            if (Configuration.TYPE_HORIZONTAL === this.config.type) {
                ...
                case Configuration.MODE_PINGPONG:
                    ...
                    this.elems.scrollItemClone.innerHTML = "",
                    maxWidth = "fixed" === prevPosition ? window.innerWidth : this.elems.container.clientWidth,
                ...
                case Configuration.MODE_CONTINOUS:
                    for (maxWidth = "fixed" === prevPosition ? window.innerWidth : this.elems.container.clientWidth; maxWidth > this.elems.scrollItem.clientWidth; )
                        this.elems.scrollItem.innerHTML += scrollContent;
                    this.elems.scrollItemClone.innerHTML = this.elems.scrollItem.innerHTML
                }
            } else {
                0 <= this.elems.scrollItem.getBoundingClientRect().height && (this.elems.scrollItem.innerHTML = "&nbsp;");
                let maxHeight = "fixed" === prevPosition ? window.innerHeight : this.elems.container.clientHeight;
                switch (this.elems.outerWrapper.style.maxHeight = maxHeight + "px",
                this.elems.scrollItem.innerHTML = "",
                this.config.mode) {
                case Configuration.MODE_PINGPONG:
                    this.elems.scrollItem.innerHTML += scrollContent,
                    this.elems.scrollItemClone.innerHTML = "",
                    maxHeight = "fixed" === prevPosition ? window.innerHeight : this.elems.container.clientHeight,
                ...
                default:
                case Configuration.MODE_CONTINOUS:
                    for (maxHeight = "fixed" === prevPosition ? window.innerHeight : this.elems.container.clientHeight; maxHeight > this.elems.scrollItem.clientHeight; )
                        this.elems.scrollItem.innerHTML += scrollContent;
                    this.elems.scrollItemClone.innerHTML = this.elems.scrollItem.innerHTML
                }
            }
            ...
            !1 === this.config.hasLicense() && window.console && !1 === hasLicenseTextBeenShown && (hasLicenseTextBeenShown = !0,
    ...
    function SuperMarquee(e, t={}) {
        ...
        var n, s;
        for (s in i)
            t.hasOwnProperty(s) ? i[s] = t[s] : e.hasAttribute("data-" + s) && (i[s] = e.getAttribute("data-" + s));
        return i.system = Configuration.SYSTEM_VANILLA,
    ...
    return Core.prototype.VERSION = "2.0",
    Core.prototype.play = function() {
        !(this._shouldPlay = !0) !== this._isInView && (this._rafId || (this._time = Date.now(),
        this.tick(),
        this._wasPlaying = !0))
    }
    ,
    Core.prototype.pause = function() {
        ...
        this._rafId ? (window.cancelAnimationFrame(this._rafId),
        this._rafId = null,
        this._wasPlaying = !0) : this._wasPlaying = !1
    }
    ,
    Core.prototype.setScrollContent = function(e) {
        this.config.setContent(e),
        this.init()
    }
    ,
    ...
    Core.prototype.setPosition = function(e) {
        switch (this.config.setPosition(e),
